...
class LineMeasurements(PfsTable):
    ...
    schema = [
        ...
        Column("flux", np.float32, "Measured flux", np.nan),
        Column("fluxErr", np.float32, "Error in measured flux", np.nan),
        Column("fluxNorm", np.float32, "Normalisation flux", np.nan),
