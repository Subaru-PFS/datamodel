...
class LineMeasurements(PfsTable):
    ...
    schema = [
        ...
        Column("x", np.float64, "x position (pixels)", np.nan),
        Column("y", np.float64, "y position (pixels)", np.nan),
        Column("xErr", np.float64, "Error in x position (pixels)", np.nan),
        Column("yErr", np.float64, "Error in y position (pixels)", np.nan),
        ...
        Column("flux", np.float64, "Relative flux", np.nan),
        Column("fluxErr", np.float64, "Error in relative flux", np.nan),
